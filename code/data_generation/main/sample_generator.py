...
def main(argv):
    ...
    output_samples('train.sample.cand-%d.sents-%d' % (n_cands, n_prev_sents), train_samples)
    output_samples('dev.sample.cand-%d.sents-%d' % (n_cands, n_prev_sents), dev_samples)
    output_samples('test.sample.cand-%d.sents-%d' % (n_cands, n_prev_sents), test_samples)
